    ...
    public void onBindViewHolder( final MonitorViewHolder holder, final int position) {
        ...
        holder.txtCount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onStatusUpdatesRequested(p);
            }
        });
        ...
        if (p.getPhotoUploadList() == null || p.getPhotoUploadList().isEmpty()) {
            ...
            Picasso.with(ctx).load(p.getPhotoUploadList().get(0).getUri()).into(holder.photo);
        }
