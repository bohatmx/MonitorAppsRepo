package com.boha.monitor.library.dialogs;
...
public class ProjectSiteDialog extends DialogFragment {
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container,
        ...
        spinner = (Spinner) view.findViewById(R.id.PSD_spinner);
    ...
    private void registerProjectSite() {
        ...
        NetUtil.sendRequest(context, w, new NetUtil.NetUtilListener() {
            @Override
