...
import com.boha.monitor.library.fragments.ContractorClaimFragment;
import com.boha.monitor.library.fragments.ContractorClaimListFragment;
...
public class ClaimAndInvoicePagerActivity extends AppCompatActivity
            ...
            public void onMessage( final ResponseDTO response) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        contractorClaimFragment.setProject(project);
                        contractorClaimListFragment.setProject(project);
                        CacheUtil.cacheProjectData(ctx,response,
