package com.boha.monitor.event.reporter;
...
import com.boha.monitor.event.reporter.fragments.AndroidCrashListFragment;
import com.boha.monitor.event.reporter.fragments.PageFragment;
import com.boha.monitor.event.reporter.fragments.ServerLogFragment;
import com.boha.monitor.event.reporter.fragments.SeverEventListFragment;
...
public class EventActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getCrashes();
        setTitle("Monitor Reporter");
    }


    private void getCrashes() {
        Log.w(LOG,"### getCrashes and events...");
        ...
        WebSocketUtil.sendRequest(ctx,Statics.COMPANY_ENDPOINT,w,new WebSocketUtil.WebSocketListener() {
            ...
            public void onMessage(final ResponseDTO r) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Log.i(LOG,"+++ response from getCrashes, status: " + r.getStatusCode());
